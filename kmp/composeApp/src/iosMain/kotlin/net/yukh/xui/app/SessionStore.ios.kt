...
actual class SessionStore {
    ...
    actual fun load(): SavedSession? {
        ...
        return SavedSession(url, token, defaults.boolForKey(KEY_INSECURE))
    }
    ...
    actual fun save(baseUrl: String, token: String, allowInsecure: Boolean) {
        ...
        defaults.setBool(allowInsecure, forKey = KEY_INSECURE)
    }

    actual fun clear() {
        defaults.removeObjectForKey(KEY_URL)
        defaults.removeObjectForKey(KEY_TOKEN)
        defaults.removeObjectForKey(KEY_INSECURE)
    }
    ...
    private companion object {
        ...
        const val KEY_INSECURE = "xui.allowInsecure"
